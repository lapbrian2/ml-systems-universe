...
const architectures: Architecture[] = [
  {
    ...
    blocks: [
      ...
      { label: 'Conv + ReLU', color: '#a855f7', height: 50 },
      { label: 'Pooling', color: '#a855f7', height: 35 },
      { label: 'Conv + ReLU', color: '#a855f7', height: 45 },
  ...
  },
  {
    ...
    blocks: [
      ...
      { label: 'Embedding', color: '#a855f7', height: 35 },
  ...
  },
  {
    ...
    blocks: [
      ...
      { label: 'Positional Enc', color: '#5b78ff', height: 30 },
      ...
      { label: 'Add & Norm', color: '#f0a500', height: 25 },
      { label: 'Linear + Softmax', color: '#a855f7', height: 40 },
