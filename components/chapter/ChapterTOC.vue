...
import { List, Check, ChevronRight } from 'lucide-vue-next'
...
const collapsed = ref(true) // collapsed on mobile by default
...
function scrollToSection(sectionId: string) {
  ...
  if (el) {
    ...
    collapsed.value = true // collapse on mobile after clicking
  }
}
</script>
...
<template>
  ...
  <!-- Mobile: floating bottom bar TOC -->
  <div class="xl:hidden fixed bottom-4 left-4 right-4 z-40">
    <Transition
